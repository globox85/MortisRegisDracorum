...
public class mainGameWindow extends JFrame implements ActionListener, KeyListener {
	...
	public void keyPressed(KeyEvent e) {
			...
			if(e.getKeyCode() == KeyEvent.VK_W){
				if(playercharacter.currentTile - 40 > 0){
				worldTiles[playercharacter.currentTile].setIcon(blackTile);
				worldTiles[playercharacter.currentTile - 40].setIcon(stoneWall);
			...
			if(e.getKeyCode() == KeyEvent.VK_A){
				worldTiles[playercharacter.currentTile].setIcon(blackTile);
				worldTiles[playercharacter.currentTile - 1].setIcon(stoneWall);
